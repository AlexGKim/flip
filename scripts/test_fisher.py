...
def main(mode = None):
    ...
    print(len(covariance_fit.covariance_dict['vv']))
...
if __name__ == '__main__':
    ...
    parameter_name_list, fisher_matrix_l = main(mode='l')
    parameter_name_list, fisher_matrix_u = main(mode='u')
    print(np.sqrt(np.linalg.inv(fisher_matrix)))   
    print(np.sqrt(np.linalg.inv(fisher_matrix_l)))
    print(np.sqrt(np.linalg.inv(fisher_matrix_u)))
